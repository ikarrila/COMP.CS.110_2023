...
struct Student {
    ...
    void set_phone_number(std::string& new_number) {
...
void change_data(Student& s,
    ...
    if(s.student_number == student_number){
        ...
        if (is_valid_phone_number(phone_number))
        {
            ...
            //fix this
            student_numbers[student_number]->set_phone_number(phone_number);
            user_ids[s.user_id]->set_phone_number(phone_number);
